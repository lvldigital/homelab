...
The website is generated using [Material for MkDocs](https://squidfunk.github.io/mkdocs-material) and can be viewed at [homelab.192.168.86.224.nip.io](https://homelab.192.168.86.224.nip.io).
...
<!-- - Find the TXT record for `homelab.192.168.86.224.nip.io` and switch the `ownerID` between `homelab` and `horus` -->
